...
// try using 1.0's rpc im nto sure why it kills itself?
#if DISCORD_ALLOWED
import Sys.sleep;
...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1410883968491978752";
	...
	private static function onReady(request:cpp.RawConstPointer<DiscordUser>):Void
	{
		...
		userID = cast(request[0].userId, String);
...
private final class DiscordPresence
{
	...
	function new()
	{
		...
		var button = DiscordButton.create();
		button.label = 'Download!';
		button.url = 'https://gamebanana.com/mods/673177';
		__presence.buttons[0] = button;
	}
