...
class FunkinSoundTray extends FlxSoundTray
{
	...
	public function new()
	{
		...
		volumeUpSound = 'soundtray/beep';
		volumeDownSound = 'soundtray/beep';
	...
	{
		y = FlxMath.lerp(y, lerpYPos, FlxMath.getElapsedLerp(0.1, FlxG.elapsed));
		alpha = FlxMath.lerp(alpha, alphaTarget, FlxMath.getElapsedLerp(0.25, FlxG.elapsed));
