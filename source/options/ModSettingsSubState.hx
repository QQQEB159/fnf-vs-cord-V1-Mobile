...
class ModSettingsSubState extends BaseOptionsMenu
{
	...
	public function new(options:Array<Dynamic>, folder:String, name:String)
	{
		...
		try
		{
			...
			{
				var newOption = new Option(option.name != null ? option.name : option.save, option.description != null ? option.description : 'No description provided.', option.save, option.type,
					option.options);
