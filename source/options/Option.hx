...
class Option
{
	public var addsVisualSpace:Bool = false;
	public var child:OptionsText;
	...
	// a bit jank but itll do
	public var isPressed:Bool = false;
	
	public var onRelease:Null<Void->Void> = null;
	
	public var onPressed:Null<Void->Void> = null;
	
	public function released()
	{
		isPressed = false;
		// used for 1 thing ever
