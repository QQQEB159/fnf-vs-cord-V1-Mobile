...
private class CustomText extends FlxText
{
	//
...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	private var grpOptions:FlxTypedGroup<CustomText>;
	private var checkboxGroup:FlxTypedGroup<CheckboxThingie>;
	private var grpTexts:FlxTypedGroup<CustomText>;
	...
	public function new()
	{
		...
		grpOptions = new FlxTypedGroup<CustomText>();
		add(grpOptions);
		
		grpTexts = new FlxTypedGroup<CustomText>();
		add(grpTexts);
		...
		{
			var optionText:CustomText = new CustomText(200, 360, optionsArray[i].name + ':');
			...
			if (optionsArray[i].type == 'bool')
			{
				...
				var checkbox:CheckboxThingie = new CheckboxThingie(optionText.x - 105, 0, optionsArray[i].getValue() == true);
				checkbox.sprTracker = optionText;
				checkbox.offsetX = optionText.width + 40;
				checkbox.ID = i;
			...
			{
				optionText.snapToPosition();
				var valueText:CustomText = new CustomText(0, 0, Std.string(optionsArray[i].getValue()));
				valueText.sprTracker = optionText;
				valueText.offset.x = -(optionText.width + 40);
				valueText.ID = i;
...
class GameplayOption
{
	...
	public function setChild(child:CustomText)
	{
		this.child = child;
	}
